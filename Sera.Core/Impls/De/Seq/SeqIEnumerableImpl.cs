    ...
    where D : ISeraColion<I>
{
    ...
    public R Collect<R, C>(ref C colctor, InType<IEnumerable<I>>? t = null) where C : ISeraColctor<IEnumerable<I>, R>
        => colctor.CSeq(new SeqListImpl<I, D>(d), new List2IEnumerableFunctor(), new Type<List<I>>());
    
    private readonly struct List2IEnumerableFunctor : ISeraFunctor<List<I>, IEnumerable<I>>
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

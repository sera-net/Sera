...
internal class _IReadOnlyCollection(Type KeyType, Type ValType) : _Generic(KeyType, ValType)
{
    ...
    public override Type GetEmitType(EmitStub stub, EmitMeta target, EmitDeps deps)
        => EmitType =
            typeof(MapIReadOnlyCollectionImpl<,,,,>).MakeGenericType(target.Type, KeyType, ValType,

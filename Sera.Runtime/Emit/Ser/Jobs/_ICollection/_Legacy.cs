...
namespace Sera.Runtime.Emit.Ser.Jobs._ICollection;

internal class _Legacy : _IEnumerable._IEnumerable
{
    public Type ImplType { get; set; } = null!;

    public override void Init(EmitStub stub, EmitMeta target)
    {
        ImplType = typeof(ICollectionSerializeRuntimeImpl<>).MakeGenericType(target.Type);
    }

...
//
// internal class _IReadOnlyCollection_Private(Type KeyType, Type ValueType) : _Private(KeyType, ValueType)
// {
//     public override void Init(EmitStub stub, EmitMeta target)
//     {
//         BaseType = typeof(IReadOnlyCollectionMapSerializeImplBase<,,>).MakeGenericType(target.Type, KeyType, ValueType);
//     }
//
//     public override EmitTransform[] CollectTransforms(EmitStub stub, EmitMeta target) => target.IsValueType
//         ? new EmitTransform[]
//         {
//             new Transforms._IReadOnlyCollectionMapSerializeImplWrapper(KeyType, ValueType),
//         }
//         : new EmitTransform[]
//         {
//             new Transforms._IReadOnlyCollectionMapSerializeImplWrapper(KeyType, ValueType),
...
//         var inst_type = typeof(IReadOnlyCollectionMapSerializeImpl<,,,,>)

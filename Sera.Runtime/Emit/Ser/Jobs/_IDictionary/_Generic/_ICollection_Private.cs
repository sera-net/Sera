...
//
// internal class _ICollection_Private(Type KeyType, Type ValueType) : _Private(KeyType, ValueType)
// {
//     public override void Init(EmitStub stub, EmitMeta target)
//     {
//         BaseType = typeof(ICollectionMapSerializeImplBase<,,>).MakeGenericType(target.Type, KeyType, ValueType);
//     }
//
//     public override EmitTransform[] CollectTransforms(EmitStub stub, EmitMeta target) => target.IsValueType
//         ? new EmitTransform[]
//         {
//             new Transforms._ICollectionMapSerializeImplWrapper(KeyType, ValueType),
//         }
//         : new EmitTransform[]
//         {
//             new Transforms._ICollectionMapSerializeImplWrapper(KeyType, ValueType),
...
//         var inst_type = typeof(ICollectionMapSerializeImpl<,,,,>)

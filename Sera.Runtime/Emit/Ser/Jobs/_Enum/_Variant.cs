...
//
// internal abstract class _Variant(Type UnderlyingType, EnumInfo[] Items, SeraUnionAttribute? EnumAttr) : _Base
// {
//     public SeraUnionAttribute? EnumAttr { get; private set; } = EnumAttr;
